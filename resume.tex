...
\namesection{Baptiste}{Gouzy}{%
%    \urlstyle{same}\href{https://jez.io}{jez.io}
 \href{mailto:baptistegouzy@gmail.com}{baptistegouzy@gmail.com}
  | 07 60 57 50 39%
}
...
\subsection{ITECSIA}
\descript{BTS SIO en alternance Option SLAM}
\location{ Septembre 2016 > Aout 2018 | Cergy Pontoise }
\sectionsep

\subsection{Lycée Jules Ferry}
\descript{Baccalauréat STMG Option SIG}
\location{ Juin 2016 | Conflans Sainte Honorine }
\sectionsep
...
\section{Lien s}
GitHub: \href{https://github.com/BaptisteGouzy}{\custombold{Baptiste}} \\
...
%\vspace{\topsep} % Hacky fix for awkward extra vertical space :*d
%\begin{tightemize}
...
\runsubsection{Ministère de l'intérieur}
\descript{| Apprentis développeur}
\location{Septembre 2016 - Aout 2018 | Paris }
